...
- **Must** be [initiatialized with the DHIS2 Application
  Platform](../../workshop/01-environment-setup/README.md)
- **Must** use a layout with sidebar navigation. See [example](../../workshop/02-ui-library/README.md) from the UI-library exercise.
